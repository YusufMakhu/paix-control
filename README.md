...
[![Donar](https://img.shields.io/badge/PayPal-donar-00457C?logo=paypal&logoColor=white)](https://yusufmakhu.github.io/paix-control/paix-web/donate.html)
...
[![Donate with PayPal](https://img.shields.io/badge/PayPal-Buy%20me%20a%20coffee-00457C?logo=paypal&logoColor=white&style=for-the-badge)](https://yusufmakhu.github.io/paix-control/paix-web/donate.html)

## FAQ

**Does the official BackPAIX / PAIX app still work?**
No. PAIX Design shut down and its cloud (AWS + `backpaix.com`) went offline, so the official **BackPAIX app no longer works**. PAIX Control is a free, independent replacement.

**Is this an alternative to the official PAIX / BackPAIX app?**
Yes — it's a complete, free **alternative app for the BackPAIX LED badge**, reverse-engineered from the original. Web app + offline Android APK, no cloud, no account.

**How do I control my PAIX badge now?**
Open the [web app](https://yusufmakhu.github.io/paix-control/paix-web/) in Chrome on Android (with your badge nearby), or install the [APK](https://github.com/YusufMakhu/paix-control/releases/latest). Then connect over Bluetooth and use the gallery, pixel editor, animated emojis or scrolling text.

**Does it work on iPhone?**
Web Bluetooth isn't available on iOS, so use **Android** (Chrome or the APK).

**Is it safe / free?**
Free and source-available — no analytics, no tracking, no servers. It only talks to your badge over Bluetooth.
